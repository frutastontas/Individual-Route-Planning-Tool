...
\begin{DoxyCompactList}\small\item\em Performs edge relaxation for a graph algorithm. \end{DoxyCompactList}\item 
...
int \mbox{\hyperlink{_planning_8cpp_a1e865f70ecbad186ba194965b43f5147}{case3}} (\mbox{\hyperlink{class_urban_map}{Urban\+Map}}$<$ std\+::string $>$ \texorpdfstring{$\ast$}{*}urban\+\_\+map)
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
This function outputs to an output.\+txt where the results can be seen.
\end{DoxyNote}
...
returns an integer that acts as a flag to check if estimation function was called (0 means yes, 1 means no)
\end{DoxyReturn}
...
Performs edge relaxation for a graph algorithm. 

This function updates the distance of the destination node of the given edge if a shorter path is found using either driving or walking mode.


\begin{DoxyTemplParams}{Template Parameters}
{\em T} & The type of the data stored in the graph nodes (e.\+g., std\+::string). \\
\hline
\end{DoxyTemplParams}

\begin{DoxyParams}{Parameters}
{\em edge} & A pointer to the edge that is being relaxed. \\
\hline
{\em Drivemode} & A boolean flag indicating the mode of transportation.
\begin{DoxyItemize}
\item If true, driving time is used.
\item If false, walking time is used.
\end{DoxyItemize}\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
True if the relaxation was successful (i.\+e., the distance was updated), false otherwise. 
\end{DoxyReturn}
